        ...
        <Col>
          <Card bg="secondary" border="light" className="mt-4">
            ...
            <Card.Body>
              ...
              <Card.Text>
                 <p>A method, developed by Dwight D, Eisenhower, that can help you decide and prioritize tasks by urgency and importance, 
                 sifting out less urgent and important tasks which you should either delegate or not do at all.</p>
                 <p>When deciding on how to rate your tasks between important and urgent, think about a few key points. For something to be urgent, 
                   ...
                   don't think about them as less meaningful, but more so that they can be put on pause or designate to others. Finally, remember these tasks can change, what was a schedule yesterday, could become a do today.</p> 
              </Card.Text>
            </Card.Body>
          </Card>
        </Col>
